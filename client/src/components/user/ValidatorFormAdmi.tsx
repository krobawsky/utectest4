...
export default class ValidatorForm extends React.Component<IUserEditorProps, IUserEditorState> {
  ...
  onSubmit(event) {
    ...
    const url = user.isNew ? '/api/loginA' : '/api/user/' + user.id;
      ...
      <form className='form-horizontal'>
       <div className='row center-align'>
        <div className='col s12 m4 offset-m4'>
          <div className='card #ffa000 amber darken-2 hoverable'>
            <div className='card-content white-text'>
              <span className='card-title'>Login Psicólogo</span>
              <div className='divider'></div>
                <div className='row'>
                  <form className='col s11' method='POST' action={url('/api/login')}>
                    <div className='row'>
                      <div className='input-field col s12'>
                          <img src='/images/admi.png' width='200' id='img' height='200' /><br/> <br/>
